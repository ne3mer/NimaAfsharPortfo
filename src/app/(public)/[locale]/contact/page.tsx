      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="mx-auto mt-6 inline-block max-w-2xl rounded-full border border-emerald-500/25 bg-emerald-500/[0.06] px-5 py-2 text-sm text-emerald-100/90 md:text-base">
              {t("openTo")}
            </p>
          </div>

          <div className="mb-10 rounded-2xl border border-white/10 bg-white/[0.03] p-5 md:p-6">
